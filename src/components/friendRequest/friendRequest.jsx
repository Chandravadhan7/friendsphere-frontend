...
export default function FriendRequest({ requestItem }) {
  ...
  const acceptFriendRequest = async () => {
    const response = await fetch(
      `http://ec2-3-110-55-80.ap-south-1.compute.amazonaws.com:8080/friendship/acceptrequest/${requestItem?.userId}`,
      {
        method: "PATCH",
        headers: {
  ...
  const rejectFriendRequest = async () => {
    const response = await fetch(
      `http://ec2-3-110-55-80.ap-south-1.compute.amazonaws.com:8080/friendship/rejectrequest/${requestItem?.userId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
  ...
  const getMutualsFriends = async () => {
    const response = await fetch(
      `http://ec2-3-110-55-80.ap-south-1.compute.amazonaws.com:8080/friendship/mutual-friends/${requestItem?.userId}`,
      {
        method: "GET",
        headers: {
          sessionId: sessionId,
